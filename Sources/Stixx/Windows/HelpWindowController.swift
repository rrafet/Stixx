...
final class HelpWindowController: NSWindowController {
    private static let entries: [(question: String, answer: String)] = [
        ...
        ("What does the tray button do?",
         "It saves the stix and puts it away without deleting it. Bring it back from File > Saved Stixx, the menu bar icon, or Find (\u{2318}F)."),
        ("How do I collapse a stix to its title?",
         "Click the chevron button, double-click the stix's top edge, or press \u{21E7}\u{2318}M. The same gesture expands it again."),
        ("How do I change a stix's color or font?",
         "Right-click the stix, or use the Format menu \u{2014} \u{2318}1 to \u{2318}6 switch colors from the keyboard."),
        ("How do I keep a stix above every window?",
         "Click the pin button in its top-right corner, or press \u{21E7}\u{2318}P."),
